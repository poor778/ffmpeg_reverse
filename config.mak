...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION= --prefix=/local2/workspace/ffmpeg-3.2.10/linux
...
CC_IDENT=gcc 5.4.0 (Ubuntu 5.4.0-6ubuntu1~16.04.9) 20160609
ARCH=x86
INTRINSICS=none
CC=gcc
CXX=g++
...
CFLAGS=   -std=c99 -fomit-frame-pointer -pthread -D_REENTRANT -I/usr/include/SDL2  -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
...
EXTRALIBS=-lXv -lX11 -lXext -ldl -lxcb -lxcb-xfixes -lxcb-render -lxcb-shape -lxcb -lxcb-shape -lxcb -lX11 -lsndio -lasound -lSDL2 -lm -lz -pthread 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
